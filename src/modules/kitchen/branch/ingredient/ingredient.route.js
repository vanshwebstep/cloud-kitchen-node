...
router.post('/', verifyToken({ checkOnboarding: true, checkSubscription: true }), validateCreateIngredient, IngredientController.CreateIngredient);
// 📌 Get All Ingredients
// GET /api/v1/kitchen/branch/:branchId/ingredient
router.get('/', verifyToken({ checkOnboarding: true, checkSubscription: true }), IngredientController.getIngredients);
